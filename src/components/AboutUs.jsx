    ...
    <div className="bg-gradient-to-b from-gray-300 via-gray-300/80 to-gray-300 mt-14 space-y-3">
      <div className="max-w-4xl mx-auto bg-slate-300 shadow-md rounded-lg p-6">
        ...
        <section className="mb-6 p-4 bg-gradient-to-br from-slate-100 via-slate-50 to-slate-50 border-gray-200 border-b-2 shadow-sm rounded-lg shadow-slate-300">
          ...
          <p className="text-gray-700 mb-2">
            In todays travel-centric era, Tourista offers a seamless platform
            for travelers to explore, customize, and book travel packages that
            showcase Indias rich cultural heritage, diverse landscapes, and
            unique experiences.
          </p>
        ...
        <div className="bg-gray-100 rounded-xl p-8 flex justify-center">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-white border-gray-100 border-b-2 hover:shadow-2xl hover:shadow-yellow-500 hover:bg-amber-100 shadow-md shadow-slate-400 rounded-lg p-6 w-80">
              <h2 className="text-2xl font-semibold mb-4">Prachi Nigudkar</h2>
              <p className="text-gray-700 mb-4">
                This project was developed by Prachi Nigudkar.
              </p>
              <div className="flex justify-center mt-4">
                <a
                  href="https://www.linkedin.com/in/prachi-nigudkar-759353248"
                  target="_blank"
